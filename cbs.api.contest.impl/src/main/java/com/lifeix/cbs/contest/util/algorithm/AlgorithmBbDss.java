 ...
 *
 */
public class AlgorithmBbDss implements AlgorithmIF {
	
	public static final double ODD_DISCOUNT = 0.9;
	public static final double EVEN_DISCOUNT = 0.9;
	...
	public AlgorithmResult settleBet(double betMoney, int betStatus, int homeScore, int visitScore, Object... oddsParams) {
		...
		double profit = BetAlgorithm.getGoalOddEvenBasketballProfit(betMoney, totalScore, oddDiscount, evenDiscount, isBetOddWin);
