 ...
 *
 */
public class AlgorithmFbSize implements AlgorithmIF {
	...
	public AlgorithmResult settleBet(double betMoney, int betStatus, int homeScore, int visitScore, Object... oddsParams) throws L99IllegalParamsException {
		...
		double profit = BetAlgorithm.getGoalSoccerProfit(betMoney, totalScore, overlineDiscount, underlineDiscount, isBetOverlineWin, type);
