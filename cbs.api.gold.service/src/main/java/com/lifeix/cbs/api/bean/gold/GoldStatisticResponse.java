...
public class GoldStatisticResponse implements JsonSerializer<GoldStatisticResponse>, Response {
    ...
    @Override
    public JsonElement serialize(GoldStatisticResponse src, Type typeOfSrc, JsonSerializationContext context) {
