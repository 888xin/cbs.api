 ...
 * 
 */
public class OddsJcResponse implements JsonSerializer<OddsJcResponse>, Response {

    private static final long serialVersionUID = -3260517732641777178L;
    ...
    @Override
    public JsonElement serialize(OddsJcResponse src, Type typeOfSrc, JsonSerializationContext context) {
