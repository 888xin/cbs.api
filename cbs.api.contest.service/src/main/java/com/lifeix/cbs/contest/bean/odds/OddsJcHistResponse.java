 ...
 * 
 */
public class OddsJcHistResponse implements JsonSerializer<OddsJcHistResponse>, Response {

    private static final long serialVersionUID = -5901331305094765880L;
    ...
    @Override
    public JsonElement serialize(OddsJcHistResponse src, Type typeOfSrc, JsonSerializationContext context) {
