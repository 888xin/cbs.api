...
@Controller
@Path("/fb/bet")
public class FbBetResource extends BaseAction {
	...
	try {
	    start();
	    CustomResponse response = fbBetService.addFBBet(getSessionAccount(request), contestId, longbi, playId, support,
    ...
    public void setFbBetService(FbBetService fbBetService) {
	this.fbBetService = fbBetService;
    }
