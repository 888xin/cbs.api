...
@Controller
@Path("/bb/odds")
public class BbOddsResource extends BaseAction {
	...
	try {
	    start();
	    OddsResponse response = bbOddsService.findBbOddsResponse(contestId, getSessionAccount(request), hasContest,
		    oddsType, client);
    ...
    public void setBbOddsService(BbOddsService bbOddsService) {
	this.bbOddsService = bbOddsService;
    }
